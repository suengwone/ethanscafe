...
final _previewNotifications = [
  AppNotification(
    ...
    route: '/profile/orders/track/pickup-1',
  ),
  AppNotification(
    id: 'points:earn-1',
    title: '포인트가 적립됐어요',
    body: '픽업 주문으로 500P를 쓰고 320P를 모았어요. 지금 잔액은 7,250P예요.',
  ...
  AppNotification(
    id: 'points:charge-1',
    title: '포인트를 충전했어요',
    body: '보너스 5,000P를 더해 55,000P가 들어왔어요. 지금 잔액은 62,250P예요.',
    category: AppNotificationCategory.points,
  ...
  AppNotification(
    id: 'pickup-2:cancelled',
    title: '주문이 취소됐어요',
    body: '아이스 아메리카노 주문이 취소되었어요. 사용하신 포인트와 쿠폰은 돌려드렸어요.',
    category: AppNotificationCategory.order,
    createdAt: DateTime(2026, 8, 1, 9),
    isRead: true,
    route: '/profile/orders/track/pickup-2',
  ),
];
