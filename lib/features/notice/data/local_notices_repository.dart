...
class LocalNoticesRepository implements NoticesRepository {
  ...
  static final _notices = <Notice>[
    ...
    Notice(
      ...
      body:
          '새로 입고된 니카라과 핀카 리브레 게이샤 출시를 기념해 '
    ...
    Notice(
      ...
      body:
          '8월 31일까지 매장 결제 시 포인트가 기본 적립률의 2배로 적립됩니다. '
          '멤버십 QR을 꼭 제시해주세요.',
    ...
    Notice(
      ...
      title: '여름 신메뉴 3종 출시',
      body:
          '수박 주스, 오렌지 몽블랑, 복숭아 아이스티까지 여름 한정 메뉴가 출시되었습니다. '
    ...
    Notice(
      ...
      body:
          '매주 화요일 오전에는 로스팅 작업으로 원두 구매 대기 시간이 '
    ...
    Notice(
      ...
      title: '원두 정기구독 오픈 예정',
      body:
          '매주 갓 볶은 원두를 집으로 보내드리는 정기구독 서비스를 준비 중입니다. '
