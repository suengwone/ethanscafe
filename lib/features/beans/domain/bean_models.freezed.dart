...
mixin _$Bean {
 ...
 String get id; String get name; String get origin; String get description; String get story; RoastLevel get roastLevel; String get process; List<String> get tastingNotes; int get acidity; int get body; int get sweetness; List<String> get recommendedBrews; int get price200; int get price500; bool get isNew; bool get soldOut; int get sortOrder; String? get imageUrl;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,origin,description,story,roastLevel,process,const DeepCollectionEquality().hash(tastingNotes),acidity,body,sweetness,const DeepCollectionEquality().hash(recommendedBrews),price200,price500,isNew,soldOut,sortOrder,imageUrl);

@override
String toString() {
  return 'Bean(id: $id, name: $name, origin: $origin, description: $description, story: $story, roastLevel: $roastLevel, process: $process, tastingNotes: $tastingNotes, acidity: $acidity, body: $body, sweetness: $sweetness, recommendedBrews: $recommendedBrews, price200: $price200, price500: $price500, isNew: $isNew, soldOut: $soldOut, sortOrder: $sortOrder, imageUrl: $imageUrl)';
}
...
@useResult
$Res call({
 String id, String name, String origin, String description, String story, RoastLevel roastLevel, String process, List<String> tastingNotes, int acidity, int body, int sweetness, List<String> recommendedBrews, int price200, int price500, bool isNew, bool soldOut, int sortOrder, String? imageUrl
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String origin,  String description,  String story,  RoastLevel roastLevel,  String process,  List<String> tastingNotes,  int acidity,  int body,  int sweetness,  List<String> recommendedBrews,  int price200,  int price500,  bool isNew,  bool soldOut,  int sortOrder,  String? imageUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Bean() when $default != null:
return $default(_that.id,_that.name,_that.origin,_that.description,_that.story,_that.roastLevel,_that.process,_that.tastingNotes,_that.acidity,_that.body,_that.sweetness,_that.recommendedBrews,_that.price200,_that.price500,_that.isNew,_that.soldOut,_that.sortOrder,_that.imageUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String origin,  String description,  String story,  RoastLevel roastLevel,  String process,  List<String> tastingNotes,  int acidity,  int body,  int sweetness,  List<String> recommendedBrews,  int price200,  int price500,  bool isNew,  bool soldOut,  int sortOrder,  String? imageUrl)  $default,) {final _that = this;
switch (_that) {
case _Bean():
return $default(_that.id,_that.name,_that.origin,_that.description,_that.story,_that.roastLevel,_that.process,_that.tastingNotes,_that.acidity,_that.body,_that.sweetness,_that.recommendedBrews,_that.price200,_that.price500,_that.isNew,_that.soldOut,_that.sortOrder,_that.imageUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String origin,  String description,  String story,  RoastLevel roastLevel,  String process,  List<String> tastingNotes,  int acidity,  int body,  int sweetness,  List<String> recommendedBrews,  int price200,  int price500,  bool isNew,  bool soldOut,  int sortOrder,  String? imageUrl)?  $default,) {final _that = this;
switch (_that) {
case _Bean() when $default != null:
return $default(_that.id,_that.name,_that.origin,_that.description,_that.story,_that.roastLevel,_that.process,_that.tastingNotes,_that.acidity,_that.body,_that.sweetness,_that.recommendedBrews,_that.price200,_that.price500,_that.isNew,_that.soldOut,_that.sortOrder,_that.imageUrl);case _:
  return null;
...
class _Bean extends Bean {
  const _Bean({required this.id, required this.name, required this.origin, required this.description, required this.story, required this.roastLevel, required this.process, required final  List<String> tastingNotes, required this.acidity, required this.body, required this.sweetness, required final  List<String> recommendedBrews, required this.price200, required this.price500, this.isNew = false, this.soldOut = false, this.sortOrder = 0, this.imageUrl}): _tastingNotes = tastingNotes,_recommendedBrews = recommendedBrews,super._();
...
@override
int get hashCode => Object.hash(runtimeType,id,name,origin,description,story,roastLevel,process,const DeepCollectionEquality().hash(_tastingNotes),acidity,body,sweetness,const DeepCollectionEquality().hash(_recommendedBrews),price200,price500,isNew,soldOut,sortOrder,imageUrl);
