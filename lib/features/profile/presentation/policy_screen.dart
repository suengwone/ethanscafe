...
const _termsSections = [
  _PolicySection(
    heading: '제1조 (목적)',
    body: "본 약관은 Ethan's Cafe(이하 \"회사\")가 제공하는 멤버십 앱 서비스(이하 \"서비스\")의 "
        '이용 조건 및 절차, 회사와 회원 간의 권리·의무 및 책임 사항을 규정함을 목적으로 합니다.',
  ),
  _PolicySection(
    heading: '제2조 (정의)',
    body: '1. "회원"이란 본 약관에 동의하고 서비스에 가입한 자를 말합니다.\n'
  ...
  _PolicySection(
    ...
    body: '1. 포인트는 매장 결제 금액의 10%가 적립되며, 원 단위 미만은 내림 처리합니다.\n'
        '2. 포인트는 보유 잔액 한도 내에서 매장 결제 시 사용할 수 있습니다.\n'
        '3. 회원 탈퇴 시 보유 포인트는 소멸되며 복구되지 않습니다.',
  ),
  _PolicySection(
    heading: '제5조 (서비스의 중단)',
    body: '회사는 시스템 점검, 교체, 고장, 통신 두절 등의 사유가 발생한 경우 '
        '서비스 제공을 일시적으로 중단할 수 있으며, 사전에 공지함을 원칙으로 합니다.',
  ),
  _PolicySection(
    heading: '제6조 (회원의 의무)',
    body: '1. 회원은 관계 법령, 본 약관의 규정, 이용 안내 사항을 준수하여야 합니다.\n'
...
const _privacySections = [
  ...
  _PolicySection(
    ...
    body: '회원 탈퇴 시 지체 없이 파기합니다. 단, 관계 법령에 따라 보존할 필요가 있는 경우 '
  ...
  _PolicySection(
    ...
    body: '회사는 원칙적으로 회원의 개인정보를 외부에 제공하지 않습니다. '
        '다만, 회원이 사전에 동의하였거나 법령의 규정에 의한 경우는 예외로 합니다.',
  ),
  _PolicySection(
    heading: '5. 정보주체의 권리',
    body: '회원은 언제든지 자신의 개인정보를 조회·수정·삭제하거나 처리 정지를 요구할 수 있습니다. '
