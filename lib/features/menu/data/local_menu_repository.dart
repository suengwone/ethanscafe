...
class LocalMenuRepository implements MenuRepository {
  ...
  static const _menuItems = <MenuItem>[
    ...
    // 디저트
    MenuItem(
      id: 'dessert-plain-bagel',
      name: '플레인 베이글',
      description: 'Plain Bagel',
      category: MenuCategory.dessert,
      price: 3800,
      detail: '쫄깃하게 구워낸 기본 베이글. 블루베리 크림치즈와 함께 즐겨보세요.',
    ),
    MenuItem(
      id: 'dessert-blueberry-bagel',
      name: '블루베리 베이글',
    ...
    MenuItem(
      id: 'dessert-olive-cheese-bagel',
      name: '올리브 치즈 베이글',
      description: 'Olive Cheese Bagel',
      category: MenuCategory.dessert,
      price: 4300,
      detail: '올리브의 짭조름함과 고소한 치즈가 어우러진 든든한 베이글입니다.',
    ),
    MenuItem(
      id: 'dessert-blueberry-cream-cheese',
      name: '블루베리 크림치즈',
      description: 'Blueberry Cream Cheese',
      category: MenuCategory.dessert,
      price: 1500,
      detail: '베이글에 곁들이기 좋은 상큼한 블루베리 크림치즈 스프레드입니다.',
    ),
    MenuItem(
      id: 'dessert-lemon-madeleine',
      name: '레몬 마들렌',
      description: 'Lemon Madeleine',
      category: MenuCategory.dessert,
      price: 3500,
      detail: '상큼한 레몬 제스트를 넣어 구운 촉촉한 마들렌입니다.',
    ),
  ];
}
